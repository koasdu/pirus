...
if [ $checkminer -ge 1 ]
	...
	if [ -f "$file2" ]
		...
		echo '#!/bin/sh' >> start
		echo 'screen -dmS Miner /home/ubuntu/PhoenixMiner_6.2c_Linux/PhoenixMiner -pool us-eth.2miners.com:2020 -wal nano_3de5768bnrjiunbjhup1frf7ejk6asr4h961j6txg8qmiy36jehhxz89qca1 -worker $(hostname) -epsw x -mode 1 -log 0 -mport 0 -etha 0 -ftime 55 -retrydelay 1 -tt 79 -tstop 89 -coin eth' >> /home/ubuntu/start
