...
./graftcp/graftcp ./bezzHash --url=ssl://9gL1cBifCAEzDjKd9ov5sHpWbxSt2jqAiHhVrXPxhWc6B6zfW7G@solo-erg.2miners.com:19999 --log --extra --latency --all-shares --shares-detail --show-mode --list-modes --mode=99
